...
def pet_by_id(id):
    ...
    if not pet:
        responce_body= '<h1>404 pet not found</h1>'
        responce=make_response(responce_body,404)
        return responce
    ...
    responce=make_response(responce_body,200)
...
def owner_by_id(id):
    ...
    if not pets:
        ...
        for pet in pets:
            response_body += f'<h2>Has pet {pet.species} named {pet.name}.'
